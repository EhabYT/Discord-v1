 ...
 *     node packages/scripts/lint-gate.js --update
...
if (errDelta > 0 || warnDelta > 0) {
    ...
    console.error('\nFix them, or run `node packages/scripts/lint-gate.js --update` if the '
...
if (errDelta < 0 || warnDelta < 0) {
    console.log(`lint gate: improved by ${-errDelta} errors / ${-warnDelta} warnings — `
        + 'run `node packages/scripts/lint-gate.js --update` to lock in the gain.');
}
process.exit(0);
