...
const { classify, ApiError, badRequest } = require('../../dashboard/middleware/errors');
...
(async () => {
    ...
    const srv = require('../../dashboard/server.js');
    ...
    const fs = require('fs');
    const src = fs.readFileSync(require('path').join(__dirname, '..', '..', 'dashboard', 'routes', 'guilds.js'), 'utf8');
