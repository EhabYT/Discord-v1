...
export default function Permissions({ guild, guildData }) {
  ...
  // Backing state for the role-search box in the dropdown below. It was
  // referenced but never declared, so opening the dropdown on a guild with
  // more than five assignable roles threw a ReferenceError and blanked the page.
