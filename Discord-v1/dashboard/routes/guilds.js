...
const guildAccess = require('../middleware/guildAccess');
const rl = require('../middleware/rateLimit');
const { withKeyLock } = require('../../utils/db_lock');
...
module.exports = (botClient) => {
    ...
    const rr = require('../../utils/reaction_roles');
    ...
    const confessions = require('../../utils/confessions');
    const board = require('../../utils/staff_board');
