    ...
    <main className="min-h-screen overflow-auto flex items-center justify-center p-4 sm:p-6 relative">
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        <a href="/" className="flex items-center justify-center gap-3 mb-6 group">
          ...
          <div className="text-left"><p className="text-sm font-bold text-white tracking-tight">EB BOT</p><p className="text-[10px] uppercase tracking-[0.16em] text-zinc-400">Dashboard V2</p></div>
        </a>
        ...
        {footer && <p className="text-xs text-zinc-400 text-center mt-5 leading-relaxed">{footer}</p>}
      </div>
    </main>
  );
}
