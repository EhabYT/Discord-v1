...
const { hasModPerms } = require('eb-bot-shared/utils/discord');
const { config, containsProfanity } = require('eb-bot-shared/config/bot-config');
const logger = require('eb-bot-shared/lib/logger');
const { getCached, setCached } = require('eb-bot-database/index');
...
module.exports = {
    ...
    async execute(message, client) {
        ...
        try { require('eb-bot-shared/services/analytics').trackMessage(message.guild.id); } catch(e) {}
        const db = client.db;
