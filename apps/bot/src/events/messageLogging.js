...
module.exports = [
    {
        ...
        async execute(message, client) {
            ...
            try {
                const { setDelete } = require('eb-bot-shared/services/snipe');
            ...
            try {
                const { emitLog } = require('eb-bot-api/websocket/socket');
    ...
    },
    {
        ...
        async execute(oldMsg, newMsg, client) {
            ...
            try {
                const { setEdit } = require('eb-bot-shared/services/snipe');
