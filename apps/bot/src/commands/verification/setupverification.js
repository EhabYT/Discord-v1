    ...
    async execute(interaction, client, db) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                .setColor(require('eb-bot-shared/config/bot-config').config.colors?.success || '#00FF00')
                .setTitle(title)
            ...
            require('eb-bot-shared/lib/logger').error('Verification setup failed', { error: error.message });
