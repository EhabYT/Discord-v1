...
import { Bot, Wifi, Activity, Radio, Eye, Gamepad2, Music2, Mic2, Trophy, Save, RefreshCw } from 'lucide-react';
...
export default function BotControls() {
  ...
  return (
    <div className="p-6 space-y-5 max-w-4xl mx-auto animate-fade-in">
      <PageHeader icon={Bot} title="Bot Controls" subtitle="Change the bot's live presence without restarting">
        ...
        <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-[#2f3136] border border-white/[0.06]">
          <div className="relative flex-shrink-0">
            <div className="w-10 h-10 rounded-full bg-cyan-500/20 border border-cyan-500/30 flex items-center justify-center">
              <span className="text-cyan-400 font-bold text-sm">EB</span>
            </div>
          ...
          <div>
            <p className="text-sm font-semibold text-white">𝑬𝑩</p>
            {actText ? (
