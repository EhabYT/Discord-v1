...
import { BarChart3, MessageSquare, UserPlus, Terminal, TrendingUp, RefreshCw, Trophy } from 'lucide-react';
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto animate-fade-in">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-white glow-text">Analytics</h1>
          <p className="text-gray-500 text-sm mt-1">24-hour activity data for {guild.name}</p>
        </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-5">
            <BarChart data={chart} dataKey="messages" color="#00FFFF" label="Messages per Hour" />
            <BarChart data={chart} dataKey="joins"    color="#00FF88" label="Member Joins per Hour" />
            <BarChart data={chart} dataKey="commands" color="#AA55FF" label="Commands per Hour" />
          </div>
